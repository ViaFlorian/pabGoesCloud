...
public class ErgebnisB015Bericht implements Comparable<ErgebnisB015Bericht> {
  ...
  @Override
  public int compareTo(ErgebnisB015Bericht that) {

    if (this.getMitarbeiterTyp().equals(that.getMitarbeiterTyp())) {
      return this.getMitarbeiterName().compareTo(that.getMitarbeiterName());
    } else {
      this.getMitarbeiterTyp().compareTo(that.getMitarbeiterTyp());
    }
