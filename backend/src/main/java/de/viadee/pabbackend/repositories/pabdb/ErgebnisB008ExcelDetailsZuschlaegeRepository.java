...
public interface ErgebnisB008ExcelDetailsZuschlaegeRepository extends
  ...
  @Query("""
      ...
      ORDER BY
          Datum ASC
           """)
  List<ErgebnisB008Details> ladeB008ExcelDetailsZuschlaege(Long projektId, Integer jahr,
